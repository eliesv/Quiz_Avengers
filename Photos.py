...
f_image = cv2.imread('C:/Users/Freddy Dratwa/Documents/GitHub/Quiz_Avengers/photos\{}.png'.format(vingador), -1)
...
cv_image = cv2.imread('C:/Users/Freddy Dratwa/Documents/GitHub/Quiz_Avengers/static/img/selfie.png')
...
for (x1, y1, w, h) in faces:
    ...
    cv2.imwrite("C:/Users/Freddy Dratwa/Documents/GitHub/Quiz_Avengers/static/img/vingador.png", dst)
    cv2.waitKey()
